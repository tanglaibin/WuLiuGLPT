 ...
 * 
 */
@WebServiceClient(name = "EpServiceService", targetNamespace = "http://webservice.jckby/", wsdlLocation = "http://localhost:8080/jckby/ws/export?wsdl")
    ...
    extends Service
{
    ...
    private final static QName EPSERVICESERVICE_QNAME = new QName("http://webservice.jckby/", "EpServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/jckby/ws/export?wsdl");
    ...
    public EpService getEpServicePort() {
        return super.getPort(new QName("http://webservice.jckby/", "EpServicePort"), EpService.class);
    }
    ...
    public EpService getEpServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.jckby/", "EpServicePort"), EpService.class, features);
    }
