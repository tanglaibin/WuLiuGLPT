...
<li id="update"><a href="#" onclick="formSubmit('shippingOrderAction_submit','_self');this.blur();">提交</a></li>
<li id="update"><a href="#" onclick="formSubmit('shippingOrderAction_cancle','_self');this.blur();">取消</a></li>
