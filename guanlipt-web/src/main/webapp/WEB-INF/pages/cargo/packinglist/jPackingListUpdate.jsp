		...
		<table class="commonTable" cellspacing="1">
	        ...
	        <tr>
	            ...
	            <td class="columnTitle">发票日期：</td>
	             ...
	             <fmt:parseDate value="${invoiceDate}" var="date" pattern="yyyy-MM-dd" type="date"/>  
					<input type="text" style="width:90px;" name="invoiceDate"
	            	 value=" <fmt:formatDate value="${date}" pattern="yyyy-MM-dd"  type="date"/> " onclick="WdatePicker({el:this,isShowOthers:true,dateFmt:'yyyy-MM-dd'});"/>
				</td>
	        </tr>	
	        <tr>
